...
urlpatterns = [
    ...
    url(r'^items/(?P<type_url>\w+)/new_item$', NewItemView.as_view(), name='new_item'),
    url(r'^items/(?P<type_url>\w+)$', ItemsListView.as_view(), name='items_list'),
    url(r'^items/(?P<type_url>\w+)/search$', SearchView.as_view(), name='search'),
    url(r'^items/(?P<type_url>\w+)/(?P<item_url>[\w-]+)$', ItemDetailView.as_view(), name='item_detail'),
    url(r'^items/(?P<type_url>\w+)/(?P<item_url>[\w-]+)/(?P<operation>\w+)$', ModifyItemView.as_view(), name='modify_item'),
    url(r'^comment/(?P<pk>\w+)/(?P<operation>\w+)$', ModifyCommentView.as_view(), name='modify_comment'),
